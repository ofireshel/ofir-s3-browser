...
function isBetter(candidate, current) {
  ...
  if ((candidate.level || 0) !== (current.level || 0)) return (candidate.level || 0) > (current.level || 0);
  return (candidate.capturedSum || 0) > (current.capturedSum || 0);
}
